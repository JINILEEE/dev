...
public class Main {
	...
	public static void main(String[] args) throws Exception{
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=gBpC67%2BTdFGh5B5yabJIW7LtjAjZqswyDJRi6nFeXyH0qFT70GaqIwc3EHnfdCzcbPI9NlCy2VMDYIMCfM0Cqg%3D%3D"); /*Service Key*/
